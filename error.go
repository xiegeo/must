...
// V2 is short for Value3, which panics on error, otherwise returns the first 3 values.
...
// V4 is short for Value2, which panics on error, otherwise returns the first 4 values.
